...
def main():
    ...
    # Filter out hosts with multiple peppapow ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple peppapow ports' % (ip_stats(ips)), file=sys.stderr)
