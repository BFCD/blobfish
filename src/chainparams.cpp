...
{
    const char* pszTimestamp = "blobfish is coming";
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1732634261, 5319695, 0x1e0ffff0, 1, 250 * COIN);
        ...
        consensus.nKAWPOWActivation = 1734123855;
        ...
        consensus.nMaxMoneyOut                           = 50000000000 * COIN;
        ...
        consensus.nTargetSpacing                         = 1 * 100;
        consensus.nTimeSlotLength                        = 15;


                // spork keys
        consensus.strSporkPubKey                         = "02261f834e88d29f46b19549536832144fc3ac3d7ef23841a295612f4015304d47";
       ...
       // Network upgrades
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].hashActivationBlock       = uint256S("0x00000cd66769b851f9a4c3b9f682244a33eead430e6e8b5f19fad90c319bcc90");
        ...
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 24);     // starting with 'B'
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "peppapow-testnet.seed.fuzzbawls.pw", true));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "peppapow-testnet.seed2.fuzzbawls.pw", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet peppapow addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet peppapow script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet peppapow BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet peppapow BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet peppapow BIP44 coin type is '1' (All coin's testnet default)
