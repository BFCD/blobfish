...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"peppapow", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"peppapow", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"peppapow", "masternodecurrent", &masternodecurrent, true },
        {"peppapow", "startmasternode", &startmasternode, true },
        {"peppapow", "createmasternodekey", &createmasternodekey, true },
        {"peppapow", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"peppapow", "listmasternodeconf", &listmasternodeconf, true },
        {"peppapow", "getmasternodestatus", &getmasternodestatus, true },
        {"peppapow", "getmasternodewinners", &getmasternodewinners, true },
        {"peppapow", "getmasternodescores", &getmasternodescores, true },
        {"peppapow", "preparebudget", &preparebudget, true },
        {"peppapow", "submitbudget", &submitbudget, true },
        {"peppapow", "mnbudgetvote", &mnbudgetvote, true },
        {"peppapow", "getbudgetvotes", &getbudgetvotes, true },
        {"peppapow", "getnextsuperblock", &getnextsuperblock, true },
        {"peppapow", "getbudgetprojection", &getbudgetprojection, true },
        {"peppapow", "getbudgetinfo", &getbudgetinfo, true },
        {"peppapow", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"peppapow", "mnfinalbudget", &mnfinalbudget, true },
        {"peppapow", "checkbudgets", &checkbudgets, true },
        {"peppapow", "mnsync", &mnsync, true },
        {"peppapow", "spork", &spork, true },
