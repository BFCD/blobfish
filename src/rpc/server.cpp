...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop BLOBFISH server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BLOBFISH server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BLOBFISH features */
        {"blobfish", "listmasternodes", &listmasternodes, true },
        {"blobfish", "getmasternodecount", &getmasternodecount, true },
        {"blobfish", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"blobfish", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"blobfish", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"blobfish", "masternodecurrent", &masternodecurrent, true },
        {"blobfish", "startmasternode", &startmasternode, true },
        {"blobfish", "createmasternodekey", &createmasternodekey, true },
        {"blobfish", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"blobfish", "listmasternodeconf", &listmasternodeconf, true },
        {"blobfish", "getmasternodestatus", &getmasternodestatus, true },
        {"blobfish", "getmasternodewinners", &getmasternodewinners, true },
        {"blobfish", "getmasternodescores", &getmasternodescores, true },
        {"blobfish", "preparebudget", &preparebudget, true },
        {"blobfish", "submitbudget", &submitbudget, true },
        {"blobfish", "mnbudgetvote", &mnbudgetvote, true },
        {"blobfish", "getbudgetvotes", &getbudgetvotes, true },
        {"blobfish", "getnextsuperblock", &getnextsuperblock, true },
        {"blobfish", "getbudgetprojection", &getbudgetprojection, true },
        {"blobfish", "getbudgetinfo", &getbudgetinfo, true },
        {"blobfish", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"blobfish", "mnfinalbudget", &mnfinalbudget, true },
        {"blobfish", "checkbudgets", &checkbudgets, true },
        {"blobfish", "mnsync", &mnsync, true },
        {"blobfish", "spork", &spork, true },
...
{
    return "> blobfish-cli " + methodname + " " + args + "\n";
}
