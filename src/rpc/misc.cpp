...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,           (numeric) the total peppapow balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zBLOBFISHsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zBLOBFISH denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zBLOBFISH denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zBLOBFISH denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBLOBFISH denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBLOBFISH denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBLOBFISH denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBLOBFISH denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zBLOBFISH denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zBLOBFISH denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,      (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,          (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,        (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,           (numeric) the transaction fee set in peppapow/kb\n"
            "  \"relayfee\": x.xxxx,           (numeric) minimum relay fee for non-free transactions in peppapow/kb\n"
    ...
    obj.push_back(Pair("zBLOBFISHsupply", zpivObj));
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"peppapowaddress\"\n"
            "\nReturn information about the given peppapow address.\n"

            "\nArguments:\n"
            "1. \"peppapowaddress\"     (string, required) The peppapow address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"peppapowaddress\",    (string) The peppapow address validated\n"
            "  \"scriptPubKey\" : \"hex\",       (string) The hex encoded scriptPubKey generated by the address\n"
            "  \"ismine\" : true|false,          (boolean) If the address is yours or not\n"
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for BLOBFISH cold staking\n"
...
#ifdef ENABLE_WALLET
        // Case 1: BLOBFISH address and we have full public key:
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are peppapow addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) peppapow address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"peppapowaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"peppapowaddress\"  (string, required) The peppapow address to use for the signature.\n"
