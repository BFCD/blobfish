...
/* Blobfish GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BLOBFISH"
#define QAPP_ORG_DOMAIN "peppapow.org"
#define QAPP_APP_NAME_DEFAULT "BLOBFISH-Qt"
#define QAPP_APP_NAME_TESTNET "BLOBFISH-Qt-testnet"
