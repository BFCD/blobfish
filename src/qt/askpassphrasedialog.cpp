...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            BLOBFISHGUI* window = static_cast<BLOBFISHGUI*>(parentWidget());
...
{
    BLOBFISHGUI* gui = static_cast<BLOBFISHGUI*>(parentWidget());
...
{
    hide();
    static_cast<BLOBFISHGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BLOBFISH will close now to finish the encryption process. "
