...
#ifndef BLOBFISH_CORE_NEW_GUI_BLOBFISHGUI_H
#define BLOBFISH_CORE_NEW_GUI_BLOBFISHGUI_H
...
/**
  BLOBFISH GUI main class. This class represents the main window of the BLOBFISH UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BLOBFISHGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BLOBFISHGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BLOBFISHGUI();
...
#endif //BLOBFISH_CORE_NEW_GUI_BLOBFISHGUI_H
