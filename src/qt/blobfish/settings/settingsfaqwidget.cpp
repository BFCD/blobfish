...
SettingsFaqWidget::SettingsFaqWidget(BLOBFISHGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableBLOBFISH,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableBLOBFISH,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableBLOBFISH,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableBLOBFISH,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableBLOBFISH, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableBLOBFISH);});
    ...
    if (parent)
        connect(parent, &BLOBFISHGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
