...
#include "qt/blobfish/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(BLOBFISHGUI* _window,QWidget *parent) :
