...
#include "qt/blobfish/settings/settingsnetworkwidget.h"
#include "qt/blobfish/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/blobfish/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BLOBFISHGUI* _window, QWidget *parent) :
