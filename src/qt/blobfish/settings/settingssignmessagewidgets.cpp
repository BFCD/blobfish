...
#include "qt/blobfish/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BLOBFISHGUI* _window, QWidget *parent) :
