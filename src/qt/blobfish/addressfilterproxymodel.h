...
#ifndef BLOBFISH_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BLOBFISH_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BLOBFISH_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
