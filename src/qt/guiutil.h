...
/** Utility functions used by the BLOBFISH Qt UI.
 */
namespace GUIUtil
{
...
// Render BLOBFISH addresses in monospace font
...
// Parse "peppapow:" URI into recipient object, return true on successful parsing
