Contributing to BLOBFISH Core
============================

The BLOBFISH Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/peppapow-project/peppapow/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BLOBFISH Core project, and is not to be
confused with overall BLOBFISH Network Protocol consensus changes.

Whether a pull request is merged into BLOBFISH Core rests with the project merge
...
Patches that change BLOBFISH consensus rules are considerably more involved than
...
Where a patchset proposes to change the BLOBFISH consensus, it must have been
...
The project leader is the release manager for each BLOBFISH Core release.
